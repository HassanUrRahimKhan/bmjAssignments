...
document.write("circumference is " + circumference)
    ...
    document.write("The value of a-- is " + a-- + "<br>")
                ...
                document.write("Remainder is " + cal%cal1)
                    ...
                    var inte = +prompt("Enter first integer")
                    var inte2= +prompt("Enter second integer")
                    ...
                    if(character=="a"||character=="e"||character=="i"||character=="o"||character=="u")
                        ...
                        var cPassword = "pakistan123"

                        var password = prompt("Enter your password")
                            while(cPassword!=password)
                            {
                                var password = prompt("Enter your password")
                                  document.write("You entered wrong password " + password)
                            }
                            ...
                            var time = document.write("Enter a time in 24 hour format")
